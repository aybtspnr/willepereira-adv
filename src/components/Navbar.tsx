    ...
    <>
      ...
      <div className="top-bar" id="topbar">
        <div className="container flex items-center justify-between">
          <div className="flex items-center gap-6" id="topbar-contacts">
            <a
              href="tel:+5548988420867"
              className="topbar-link"
              aria-label="Ligar para (48) 98842-0867"
            >
              <Phone size={11} className="topbar-icon" />
              <span>(48) 98842-0867</span>
            </a>
            <a
              href="mailto:contato@willepereira.adv.br"
              className="topbar-link hide-mobile-email"
              aria-label="Enviar email para contato@willepereira.adv.br"
            >
              <Mail size={11} className="topbar-icon" />
              <span>contato@willepereira.adv.br</span>
            </a>
          </div>
      ...
      <nav className={`nav-wrap ${scrolled ? 'scrolled' : ''}`} aria-label="Navegação principal">
        <div className="nav-inner">
          ...
          {/* Desktop nav */}
          <div className="nav-desktop" id="desktop-nav">
            ...
            <Link to="/contato" className="btn btn-gold nav-cta-btn">
              Fale Conosco
            </Link>
          </div>
            ...
            >
              ...
              <div className="mobile-menu-inner">
                ...
                >
                  ...
                  <a href="tel:+5548988420867" className="mobile-contact-link" aria-label="Ligar para (48) 98842-0867">
                    <Phone size={13} className="mobile-contact-icon" />
                    (48) 98842-0867
                  </a>
                  <a href="mailto:contato@willepereira.adv.br" className="mobile-contact-link" aria-label="Enviar email">
                    <Mail size={13} className="mobile-contact-icon" />
                    contato@willepereira.adv.br
                  </a>
                </motion.div>
              </div>
            </motion.div>
