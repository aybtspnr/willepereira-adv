      ...
      <div className="top-bar" id="topbar">
        <div className="container flex items-center justify-between">
          <div className="flex items-center gap-6">
            <a href="tel:+5548988420867" className="topbar-link" aria-label="Ligar para (48) 98842-0867">
              <Phone size={11} className="topbar-icon" />
              <span>(48) 98842-0867</span>
            </a>
            <a href="mailto:contato@willepereira.adv.br" className="topbar-link" aria-label="Enviar email">
