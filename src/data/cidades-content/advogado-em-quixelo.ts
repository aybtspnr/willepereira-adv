export default {
  ...
  "areaContent": {
    ...
    "trabalhista": "O Direito Trabalhista protege relações entre empregados e empregadores. Em Quixelô/CE, oferecemos assessoria completa: verbas rescisórias, horas extras, FGTS, assédio moral e acidente de trabalho. A economia local baseada em Turismo, Indústria e Comércio gera demandas trabalhistas específicas que conhecemos.\n\nAtuamos na defesa de trabalhadores que tiveram direitos violados e na consultoria preventiva para empresas. Principais direitos: pagamento correto de horas extras, verbas rescisórias, depósito do FGTS, estabilidade para acidentados e combate ao assédio.",
    "civel": "O Direito Cível abrange relações cotidianas. Em Quixelô/CE, atuamos em contratos, indenizações, cobranças, usucapião e questões de propriedade. A economia local baseada em Turismo, Indústria e Comércio gera conflitos cíveis que exigem conhecimento aprofundado do Código Civil.\n\nTrabalhamos com elaboração e revisão de contratos, ações de cobrança, indenização por danos morais e materiais, usucapião e todas as questões cíveis que possam surgir no cotidiano dos moradores de Quixelô.",
    "consumidor": "O CDC protege moradores de Quixelô/CE contra abusos de empresas. Atendemos consumidores com produtos defeituosos, cobranças indevidas, negativas de planos de saúde e cláusulas abusivas. A economia local baseada em Turismo, Indústria e Comércio gera demandas consumeristas que conhecemos.\n\nDominamos inversão do ônus da prova, repetição de indébito e indenização por danos morais, garantindo a reparação adequada para cada caso.",
    "familia": "O Direito de Família lida com questões sensíveis. Em Quixelô/CE, atendemos em divórcios, guarda, pensão alimentícia, inventários e união estável. Cada caso é tratado com discrição e profissionalismo.\n\nOferecemos mediação familiar, acordos consensuais e litígios quando necessário, sempre protegendo os direitos dos clientes, especialmente crianças e idosos.",
    "imobiliario": "O Direito Imobiliário regula questões de imóveis. Em Quixelô/CE, atuamos em compra e venda, locação, usucapião e regularização fundiária. A economia local baseada em Turismo, Indústria e Comércio gera demandas imobiliárias que conhecemos.\n\nTrabalhamos com due diligence completa, elaboração de contratos e resolução de conflitos possessórios e condominiais."
  },
  "exclusiva": "## Por Que Escolher a Will & Pereira Advocacia em Quixelô?\n\n**Experiência:** Mais de 15 anos de atuação em todas as áreas do Direito.\n\n**Conhecimento Local:** Conhecemos as particularidades de Quixelô e da região de Ceará.\n\n**Atendimento Personalizado:** Cada caso recebe atenção individualizada.\n\n**Atuação Nacional:** Atendemos presencialmente e por videoconferência em todo o Brasil.\n\n**Transparência:** Honorários claros, sem surpresas.",
  "diaADia": "## Como um Advogado Pode Ajudar em Quixelô\n\n**Prevenção:** Análise de contratos, planejamento previdenciário, regularização de imóveis.\n\n**Resolução:** Muitos conflitos se resolvem sem ação judicial, economizando tempo.\n\n**Emergência:** Atendimento prioritário para situações urgentes.",
  "faqs": [
    {
      "p": "Áreas mais comuns em Quixelô?",
      "r": "Em Quixelô/CE, as áreas variam conforme a economia (Turismo, Indústria e Comércio). Atuamos em todas com excelência."
    },
    {
      "p": "Como funciona o atendimento?",
      "r": "Presencial em Palhoça/SC e por videoconferência para todo o Brasil, incluindo Quixelô."
    },
    {
    ...
    {
      "p": "Atendem Quixelô?",
      "r": "Sim! Atendemos Quixelô e toda a região de CE."
    },
    {
